...
public class RegisterUser extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PreparedStatement ps=con.prepareStatement("insert into user (firstname,lastname,email,phno,password,address,state,city) values (?,?,?,?,?,?,?,?)");  
	...
	//	out.print("You are successfully registered...\n your Username is "+email+"Password is :"+pass);
		...
		out.print("Click &nbsp&nbsp<a href='login.jsp'>LOGIN</a>");
