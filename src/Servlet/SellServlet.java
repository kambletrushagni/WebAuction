...
public class SellServlet extends HttpServlet 
{
	...
	public Connection getConnection() throws SQLException 
	{
		...
		con = DriverManager.getConnection("jdbc:mysql://localhost:3306/demo","tashu","123456");
         		...
         		if (session == null ) 
		{
			...
			if(bol==true)
			{
				...
				if(password.equals(pwd))
				{
					...
					String squery = "insert into item_master(itemid,itemname,des,summary,startprice,incrprice,stdate,enddate,seller,bidcnt) values("+titemid+",'"+itemname+"','"+desc+"','"+summary+"',"+startprice+","+incrprice+",curdate(),curdate()+"+acDays+",'"+seller+"',0) ";
