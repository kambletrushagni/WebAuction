...
<FONT FACE="Comic Sans MS" SIZE="6">NETAuction</FONT></B>
...
<center>
      <%
	    ...
	    ResultSet rs2=st.executeQuery("select im.painting_id,im.type,im.image_name,im.startprice,im.enddate,im.painter_id,bi.bidder_id,bi.bamt from painting im,bidder bi where im.enddate<= curdate() and bi.status=1 and im.painting_id=bi.painting_id order by painting_id");
