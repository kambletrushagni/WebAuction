...
*/
String strSql="select painting_id,painter_id,image_name,description,type,startprice,incrementprice,dateofcreation,enddate from painting where painter_id="+a+"";
...
temp[3]=rs.getString("painter_id");
  ...
  <div class="col">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <A href="./bidder.jsp?painter_id=<%=temp[0]%>"><center><b>View Bidders</b></center></A><STRONG></STRONG></div>
      </div>
    </div>
    </div>
    <br><br>
